...
kp_calculator.geometry("312x324")

# Resizing window
kp_calculator.resizable(0, 0)
...
input_frame = Frame(kp_calculator, width=312, height=50, bd=0, highlightbackground="pink", highlightcolor="black", highlightthickness=2)
...
buttons_frame = Frame(kp_calculator, width=312, height=272.5, bg="orange")
buttons_frame.pack()

# First row, two buttons, 'Clear' and 'Divide'
clear = Button(buttons_frame, text="Clear", fg="black", width=32, height=3, bd=0, bg="#eee", cursor="hand2", command=lambda: button_clear().grid(row=0, column=0, columnspan=3, padx=1, pady=1))
